namespace Honeypot.Filter.TagHelpers
{
    ...
    public class HoneypotCheckboxTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var markup = $@"
                            <div {inlineStyle} class=""form-check"">
                                <input {inlineStyle} class=""form-check-input"" type=""checkbox"" value=""{Value}"" name=""mask-{Name}""> id=""mask-{Name}"">
                                <label {inlineStyle} class=""form-check-label"" for=""mask-{Name}"">
                                    {Label}
                                </label>
                            </div>
                            <div class=""form-check"">
                                <input class=""form-check-input"" type=""checkbox"" value=""{Value}"" id=""{hashedFieldNameOrId}"" name=""{hashedFieldNameOrId}"">
